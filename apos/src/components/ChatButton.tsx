...
export default function ChatButton({ onClick, hasNewMessages }: ChatButtonProps) {
  return (
    <button
      onClick={onClick}
      className="bg-gradient-to-r from-[#4F46E5] to-[#7C3AED] text-white w-12 h-12 sm:w-14 sm:h-14 rounded-full hover:shadow-lg hover:from-[#4338CA] hover:to-[#6D28D9] shadow-md transition-all relative flex items-center justify-center"
